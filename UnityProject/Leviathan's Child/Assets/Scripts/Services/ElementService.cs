...
{
    public static ElementService instance = null;
    ...
    {
        StartCoroutine(Get($"{ServicesController.apiUrl}/api/element/{id}"));
    }

    public void GetAll()
    {
        StartCoroutine(Get($"{ServicesController.apiUrl}/api/element"));
    }
