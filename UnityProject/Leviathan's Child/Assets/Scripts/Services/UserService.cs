...
public class UserService : MonoBehaviour
{
    ...
    public void Authentication(string nick, string password)
    {
        AuthenticationData data = new AuthenticationData() { nick = nick, password = password };
        StartCoroutine(Post($"{ServicesController.apiUrl}/api/user/authentication", data));
    }

    public void GetById(string id)
    {
        StartCoroutine(Get($"{ServicesController.apiUrl}/api/user/{id}"));
    }
